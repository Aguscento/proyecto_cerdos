...
int main(){
    ...
    int inicio = 0;                                        // contador para marcar un inicio en maxrrano
    int puntos_oink1 = 0, puntos_oink2 = 0;
    int maxrrano1, maxrrano2;
    int puntos_maxrrano1 = 0, puntos_maxrrano2 = 0;
    ...
    while (salir == "N") {
        switch( menu_principal())
        {
            case 1:
                            ...
                            if (cantidad == 2){                                                        // caso si la cantidad de dados es 2
                                if(dados[0] != dados[1] && dados[0] !=1 && dados[1]!=1){               // Si las caras son distintas entre sí y ninguna de ellas es un as
                                    ...
                                    if (inicio <= 1){                           // maxrrano
                                        ...
                                        if (jugando == jugador1){
                                            if (resultado > maxrrano1){
                                                maxrrano1 = resultado;
                                            }
                                        } else{
                                            if (resultado > maxrrano2){
                                                maxrrano2 = resultado;
                                            }
                                        }
                                    }
                                    //cout << maxrrano1 << endl << maxrrano2 << endl;
                ...
                //Conteo de OINKS
                puntos_oink1 = Oink1 *2;
                puntos_oink2 = Oink2 *2;
                total1 += Oink1 * 2;
                total2 += Oink2 * 2;
                ...
                //------------------------------------------------------------------------------
                /* comparacion de maxrrano*/
                if (maxrrano1 > maxrrano2){
                    puntos_maxrrano1 = 1;
                    if (TrufasJ2 > TrufasJ1){
                        PuntosJ2 --;
                        a = true;
                    }
                    if ((TrufasJ2/50) > (TrufasJ1/50)){
                        Cada50J2 --;
                    }
                    if (Oink2 > Oink1){
                        puntos_oink2 --;
                    ...
                    if (maxrrano2 > maxrrano1){
                        puntos_maxrrano2= 1;
                    }
                    if (TrufasJ1 > TrufasJ2){
                        PuntosJ1 --;
                    }
                    if ((TrufasJ1/50) > (TrufasJ2/50)){
                        Cada50J1 --;
                    }
                    if (Oink1 > Oink2){
                        puntos_oink1 --;
                ...
                total1 = puntos_maxrrano1 + PuntosJ1 + Cada50J1 + puntos_oink1 + codicia1;
                total2 = puntos_maxrrano2 + PuntosJ2 + Cada50J2 + puntos_maxrrano2 + codicia2;
                ...
                cout << "Oinks                      " << (puntos_oink1) << " (" << Oink1 << " Oinks)"<< "                           " << (puntos_oink2) << " (" << Oink2 << " Oinks)" << endl << endl;
                cout << "Cerdo codicioso            " << codicia1 << " PDV (" << lanzamientosJ1 << " lanzamientos)"<< "                " << codicia2 << " PDV (" << lanzamientosJ2 << " lanzamientos)" << endl << endl;
                cout << "Maxrrano                   " << puntos_maxrrano1 << " PDV" << "                                          " << puntos_maxrrano2 << " PDV" << endl;
                cout << "---------------------------------------------------------------------------------------" << endl;
